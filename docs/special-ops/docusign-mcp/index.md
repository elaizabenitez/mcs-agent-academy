...
1. An employment agreement - [download the sample employment agreement](assets/Sample Employment Agreement.docx)
1. An employee offer letter - [download the sample offer letter](assets/Sample Offer Letter.docx)
...
1. Select the Sample Employment Agreement file. [Download the Sample Employment Agreement](assets/Sample Employment Agreement.docx) if you haven't already.
...
1. Another confirmation message on the bottom left will appear to let you know the Draft template has been Published.
    ...
    Now create the second Document Template using the [Sample Offer Letter file](assets/Sample Offer Letter.docx), following the same steps as the first template.
